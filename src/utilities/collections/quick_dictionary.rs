...
use crate::utilities::memory::{buffer::Buffer, unmanaged_mempool::IUnmanagedMemoryPool};
use std::{
    ...
    TKey: Eq + Hash,
{
    ...
    pub fn with_capacity(
        ...
        let mut initial_table_span = pool.take(initial_capacity << table_power_offset).unwrap();
