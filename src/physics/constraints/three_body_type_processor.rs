...
impl<
        ...
        TSolveAccessFilterC: IBodyAccessFilter + 'static,
    > ITypeProcessor
    for ThreeBodyTypeProcessorImpl<
        TPrestepData,
        TAccumulatedImpulse,
        TConstraintFunctions,
        TWarmStartAccessFilterA,
    ...
    >
{
    ...
    fn update_for_body_memory_move(
        ...
        unsafe {
            ...
            // Body references are laid out as 3 consecutive Vector<int>, one per body.
            ...
            let reference_location =
                &mut *body_refs_base.add(bundle_index * 3 * vector_len + lane_offset);
    ...
    fn regather(
        ...
        unsafe {
            ...
            let body_ref_target =
                type_batch.body_references.as_mut_ptr() as *mut ThreeBodyReferences;
    ...
    fn add_waking_body_handles_to_batch_references(
        ...
        unsafe {
            let body_refs = type_batch.body_references.as_ptr() as *const ThreeBodyReferences;
