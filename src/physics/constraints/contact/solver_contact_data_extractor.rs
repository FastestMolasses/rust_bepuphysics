...
pub trait ISolverContactDataExtractor {
    ...
    fn convex_one_body<
        TPrestep: IConvexContactPrestep,
        TAccumulatedImpulses: IConvexContactAccumulatedImpulses,
    >(
        &mut self,
    ...
    /// Constraint data is in the first lane of the direct reference (slot 0 of vectors).
    fn convex_two_body<
        TPrestep: ITwoBodyConvexContactPrestep,
        TAccumulatedImpulses: IConvexContactAccumulatedImpulses,
    >(
        &mut self,
    ...
    fn nonconvex_one_body<
        TPrestep: INonconvexContactPrestep,
        TAccumulatedImpulses: INonconvexContactAccumulatedImpulses,
    >(
        &mut self,
        body_handle: BodyHandle,
        prestep: &mut TPrestep,
    ...
    fn nonconvex_two_body<
        TPrestep: ITwoBodyNonconvexContactPrestep,
        TAccumulatedImpulses: INonconvexContactAccumulatedImpulses,
    >(
        &mut self,
        body_handle_a: BodyHandle,
