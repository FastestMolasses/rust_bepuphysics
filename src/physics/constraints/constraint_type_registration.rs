    ...
    ($desc:ty, $prestep:ty, $impulse:ty, $funcs:ty, $type_id:expr, $dof:expr, $solve_a:ty, $solve_b:ty) => {
        impl IConstraintDescription for $desc {
            fn apply_description(
                ...
                let prestep = unsafe {
                    &mut *(batch.prestep_data.as_mut_ptr() as *mut $prestep)
            ...
            fn create_type_processor() -> TypeProcessor {
                TypeProcessor::new(
                    $type_id,
                    Box::new(TwoBodyTypeProcessorImpl::<
                        $prestep,
                        $impulse,
                        $funcs,
                        $solve_a,
    ...
    ($desc:ty, $prestep:ty, $impulse:ty, $funcs:ty, $type_id:expr, $dof:expr, $solve_a:ty) => {
        impl IConstraintDescription for $desc {
            ...
            fn create_type_processor() -> TypeProcessor {
                TypeProcessor::new(
                    $type_id,
                    Box::new(OneBodyTypeProcessorImpl::<
                        $prestep,
                        $impulse,
                        $funcs,
                        $solve_a,
    ...
    ($desc:ty, $prestep:ty, $impulse:ty, $funcs:ty, $type_id:expr, $dof:expr, $solve_a:ty, $solve_b:ty, $solve_c:ty) => {
        impl IConstraintDescription for $desc {
            ...
            fn create_type_processor() -> TypeProcessor {
                TypeProcessor::new(
                    $type_id,
                    Box::new(ThreeBodyTypeProcessorImpl::<
                        $prestep,
                        $impulse,
                        $funcs,
                        $solve_a,
    ...
    ($desc:ty, $prestep:ty, $impulse:ty, $funcs:ty, $type_id:expr, $dof:expr, $solve_a:ty, $solve_b:ty, $solve_c:ty, $solve_d:ty) => {
        impl IConstraintDescription for $desc {
            ...
            fn create_type_processor() -> TypeProcessor {
                TypeProcessor::new(
                    $type_id,
                    Box::new(FourBodyTypeProcessorImpl::<
                        $prestep,
                        $impulse,
                        $funcs,
                        $solve_a,
...
use crate::physics::constraints::angular_swivel_hinge::{
    AngularSwivelHingeFunctions, AngularSwivelHingePrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::weld::{WeldAccumulatedImpulses, WeldFunctions, WeldPrestepData};
impl_two_body_functions!(WeldFunctions, WeldPrestepData, WeldAccumulatedImpulses);

use crate::physics::constraints::distance_servo::{
    DistanceServoFunctions, DistanceServoPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::distance_limit::{
    DistanceLimitFunctions, DistanceLimitPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::center_distance_constraint::{
    CenterDistanceConstraintFunctions, CenterDistancePrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::center_distance_limit::{
    CenterDistanceLimitFunctions, CenterDistanceLimitPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::point_on_line_servo::{
    PointOnLineServoFunctions, PointOnLineServoPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::linear_axis_servo::{
    LinearAxisServoFunctions, LinearAxisServoPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::linear_axis_motor::{
    LinearAxisMotorFunctions, LinearAxisMotorPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::linear_axis_limit::{
    LinearAxisLimitFunctions, LinearAxisLimitPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::angular_axis_motor::{
    AngularAxisMotorFunctions, AngularAxisMotorPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::angular_axis_gear_motor::{
    AngularAxisGearMotorFunctions, AngularAxisGearMotorPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::hinge::{
    HingeAccumulatedImpulses, HingeFunctions, HingePrestepData,
};
impl_two_body_functions!(HingeFunctions, HingePrestepData, HingeAccumulatedImpulses);

use crate::physics::constraints::ball_socket_servo::{
    BallSocketServoFunctions, BallSocketServoPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::ball_socket_motor::{
    BallSocketMotorFunctions, BallSocketMotorPrestepData,
};
impl_two_body_functions!(
...
use crate::physics::constraints::one_body_angular_servo::{
    OneBodyAngularServoFunctions, OneBodyAngularServoPrestepData,
};
impl_one_body_functions!(
    OneBodyAngularServoFunctions,
    OneBodyAngularServoPrestepData,
    Vector3Wide
);

use crate::physics::constraints::one_body_angular_motor::{
    OneBodyAngularMotorFunctions, OneBodyAngularMotorPrestepData,
};
impl_one_body_functions!(
...
use crate::physics::constraints::one_body_linear_servo::{
    OneBodyLinearServoFunctions, OneBodyLinearServoPrestepData,
};
impl_one_body_functions!(
...
use crate::physics::constraints::one_body_linear_motor::{
    OneBodyLinearMotorFunctions, OneBodyLinearMotorPrestepData,
};
impl_one_body_functions!(
...
use crate::physics::constraints::area_constraint::{
    AreaConstraintFunctions, AreaConstraintPrestepData,
};
impl_three_body_functions!(
...
use crate::physics::constraints::volume_constraint::{
    VolumeConstraintFunctions, VolumeConstraintPrestepData,
};
impl_four_body_functions!(
...
// Convex one-body
impl_contact_one_body_functions!(
...
// Convex two-body
impl_contact_two_body_functions!(
    Contact1Functions,
    Contact1PrestepData,
    Contact1AccumulatedImpulses
);
    ...
    > for Contact2NonconvexOneBodyFunctionsImpl
{
    fn warm_start(
        ...
        orientation_a: &QuaternionWide,
        inertia_a: &BodyInertiaWide,
        prestep: &mut Contact2NonconvexOneBodyPrestepData,
        accumulated_impulses: &mut Contact2NonconvexAccumulatedImpulses,
        wsv_a: &mut BodyVelocityWide,
    ) {
        ContactNonconvexOneBodyFunctions::warm_start(
            position_a,
            orientation_a,
            inertia_a,
            prestep,
    ...
    fn solve(
        ...
        ContactNonconvexOneBodyFunctions::solve(
            position_a,
            orientation_a,
            inertia_a,
            dt,
    ...
    > for Contact3NonconvexOneBodyFunctionsImpl
{
    fn warm_start(
        ...
        orientation_a: &QuaternionWide,
        inertia_a: &BodyInertiaWide,
        prestep: &mut Contact3NonconvexOneBodyPrestepData,
        accumulated_impulses: &mut Contact3NonconvexAccumulatedImpulses,
        wsv_a: &mut BodyVelocityWide,
    ) {
        ContactNonconvexOneBodyFunctions::warm_start(
            position_a,
    ...
    > for Contact4NonconvexOneBodyFunctionsImpl
{
    fn warm_start(
        ...
        orientation_a: &QuaternionWide,
        inertia_a: &BodyInertiaWide,
        prestep: &mut Contact4NonconvexOneBodyPrestepData,
        accumulated_impulses: &mut Contact4NonconvexAccumulatedImpulses,
        wsv_a: &mut BodyVelocityWide,
    ) {
        ContactNonconvexOneBodyFunctions::warm_start(
            position_a,
    ...
    for Contact2NonconvexTwoBodyFunctionsImpl
{
    fn warm_start(
        ...
        orientation_b: &QuaternionWide,
        inertia_b: &BodyInertiaWide,
        prestep: &mut Contact2NonconvexPrestepData,
        accumulated_impulses: &mut Contact2NonconvexAccumulatedImpulses,
        wsv_a: &mut BodyVelocityWide,
        wsv_b: &mut BodyVelocityWide,
    ) {
        ContactNonconvexTwoBodyFunctions::warm_start(
            position_a,
            orientation_a,
            inertia_a,
            position_b,
    ...
    fn solve(
        ...
        ContactNonconvexTwoBodyFunctions::solve(
            position_a,
            orientation_a,
            inertia_a,
            position_b,
    ...
    fn incrementally_update_for_substep(
        ...
        ContactNonconvexTwoBodyFunctions::incrementally_update_for_substep(
            dt, wsv_a, wsv_b, prestep,
        );
    }
}
    ...
    for Contact3NonconvexTwoBodyFunctionsImpl
{
    fn warm_start(
        ...
        orientation_b: &QuaternionWide,
        inertia_b: &BodyInertiaWide,
        prestep: &mut Contact3NonconvexPrestepData,
        accumulated_impulses: &mut Contact3NonconvexAccumulatedImpulses,
        wsv_a: &mut BodyVelocityWide,
        wsv_b: &mut BodyVelocityWide,
    ) {
    ...
    for Contact4NonconvexTwoBodyFunctionsImpl
{
    fn warm_start(
        ...
        orientation_b: &QuaternionWide,
        inertia_b: &BodyInertiaWide,
        prestep: &mut Contact4NonconvexPrestepData,
        accumulated_impulses: &mut Contact4NonconvexAccumulatedImpulses,
        wsv_a: &mut BodyVelocityWide,
        wsv_b: &mut BodyVelocityWide,
    ) {
...
impl_contact_one_body_description!(
    ...
    Contact2NonconvexOneBodyPrestepData,
    Contact2NonconvexAccumulatedImpulses,
    Contact2NonconvexOneBodyFunctionsImpl,
    8,
    6
);
impl_contact_one_body_description!(
    ...
    Contact3NonconvexOneBodyPrestepData,
    Contact3NonconvexAccumulatedImpulses,
    Contact3NonconvexOneBodyFunctionsImpl,
    9,
    9
);
impl_contact_one_body_description!(
    ...
    Contact4NonconvexOneBodyPrestepData,
    Contact4NonconvexAccumulatedImpulses,
    Contact4NonconvexOneBodyFunctionsImpl,
    10,
    12
);
...
impl_contact_two_body_description!(
    ...
    Contact2NonconvexAccumulatedImpulses,
    Contact2NonconvexTwoBodyFunctionsImpl,
    15,
    6
);
impl_contact_two_body_description!(
    ...
    Contact3NonconvexAccumulatedImpulses,
    Contact3NonconvexTwoBodyFunctionsImpl,
    16,
    9
);
impl_contact_two_body_description!(
    ...
    Contact4NonconvexAccumulatedImpulses,
    Contact4NonconvexTwoBodyFunctionsImpl,
    17,
    12
);
