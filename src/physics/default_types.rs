...
impl DefaultTypes {
    ...
    pub fn create_default_collision_task_registry() -> crate::physics::collision_detection::collision_task_registry::CollisionTaskRegistry {
        ...
        use crate::physics::collision_detection::collision_tasks::pair_types::{
            SpherePair, SphereIncludingPair, FliplessPair, CollisionPair,
            SpherePairWide, SphereIncludingPairWide, FliplessPairWide, ConvexPairWide,
        };
        ...
        registry.register(Box::new(create_convex_collision_task_with_ids::<
            SpherePair, SpherePairWide, SphereWide, SphereWide,
            Convex1ContactManifoldWide, SpherePairTester,
        >(Sphere::ID, Sphere::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            SphereIncludingPair, SphereIncludingPairWide<CapsuleWide>, SphereWide, CapsuleWide,
            Convex1ContactManifoldWide, SphereCapsuleTester,
        >(Sphere::ID, Capsule::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            SphereIncludingPair, SphereIncludingPairWide<BoxWide>, SphereWide, BoxWide,
            Convex1ContactManifoldWide, SphereBoxTester,
        >(Sphere::ID, BoxShape::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            SphereIncludingPair, SphereIncludingPairWide<TriangleWide>, SphereWide, TriangleWide,
            Convex1ContactManifoldWide, SphereTriangleTester,
        >(Sphere::ID, Triangle::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            SphereIncludingPair, SphereIncludingPairWide<CylinderWide>, SphereWide, CylinderWide,
            Convex1ContactManifoldWide, SphereCylinderTester,
        >(Sphere::ID, Cylinder::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            SphereIncludingPair, SphereIncludingPairWide<ConvexHullWide>, SphereWide, ConvexHullWide,
            Convex1ContactManifoldWide, SphereConvexHullTester,
        ...
        // ── Capsule vs convex ─────────────────────────────────────────
        registry.register(Box::new(create_convex_collision_task_with_ids::<
            FliplessPair, FliplessPairWide<CapsuleWide>, CapsuleWide, CapsuleWide,
            Convex2ContactManifoldWide, CapsulePairTester,
        >(Capsule::ID, Capsule::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<CapsuleWide, BoxWide>, CapsuleWide, BoxWide,
            Convex2ContactManifoldWide, CapsuleBoxTester,
        >(Capsule::ID, BoxShape::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<CapsuleWide, TriangleWide>, CapsuleWide, TriangleWide,
            Convex2ContactManifoldWide, CapsuleTriangleTester,
        >(Capsule::ID, Triangle::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<CapsuleWide, CylinderWide>, CapsuleWide, CylinderWide,
            Convex2ContactManifoldWide, CapsuleCylinderTester,
        >(Capsule::ID, Cylinder::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<CapsuleWide, ConvexHullWide>, CapsuleWide, ConvexHullWide,
            Convex2ContactManifoldWide, CapsuleConvexHullTester,
        ...
        // ── Box vs convex ─────────────────────────────────────────────
        registry.register(Box::new(create_convex_collision_task_with_ids::<
            FliplessPair, FliplessPairWide<BoxWide>, BoxWide, BoxWide,
            Convex4ContactManifoldWide, BoxPairTester,
        >(BoxShape::ID, BoxShape::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<BoxWide, TriangleWide>, BoxWide, TriangleWide,
            Convex4ContactManifoldWide, BoxTriangleTester,
        >(BoxShape::ID, Triangle::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<BoxWide, CylinderWide>, BoxWide, CylinderWide,
            Convex4ContactManifoldWide, BoxCylinderTester,
        >(BoxShape::ID, Cylinder::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<BoxWide, ConvexHullWide>, BoxWide, ConvexHullWide,
            Convex4ContactManifoldWide, BoxConvexHullTester,
        ...
        // ── Triangle vs convex ────────────────────────────────────────
        registry.register(Box::new(create_convex_collision_task_with_ids::<
            FliplessPair, FliplessPairWide<TriangleWide>, TriangleWide, TriangleWide,
            Convex4ContactManifoldWide, TrianglePairTester,
        >(Triangle::ID, Triangle::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<TriangleWide, CylinderWide>, TriangleWide, CylinderWide,
            Convex4ContactManifoldWide, TriangleCylinderTester,
        >(Triangle::ID, Cylinder::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<TriangleWide, ConvexHullWide>, TriangleWide, ConvexHullWide,
            Convex4ContactManifoldWide, TriangleConvexHullTester,
        ...
        // ── Cylinder vs convex ────────────────────────────────────────
        registry.register(Box::new(create_convex_collision_task_with_ids::<
            FliplessPair, FliplessPairWide<CylinderWide>, CylinderWide, CylinderWide,
            Convex4ContactManifoldWide, CylinderPairTester,
        >(Cylinder::ID, Cylinder::ID)));

        registry.register(Box::new(create_convex_collision_task_with_ids::<
            CollisionPair, ConvexPairWide<CylinderWide, ConvexHullWide>, CylinderWide, ConvexHullWide,
            Convex4ContactManifoldWide, CylinderConvexHullTester,
        ...
        registry.register(Box::new(create_convex_collision_task_with_ids::<
            FliplessPair, FliplessPairWide<ConvexHullWide>, ConvexHullWide, ConvexHullWide,
            Convex4ContactManifoldWide, ConvexHullPairTester,
    ...
    pub fn create_default_sweep_task_registry() -> SweepTaskRegistry {
        use crate::physics::collidables::sphere::{Sphere, SphereWide, SphereSupportFinder};
        use crate::physics::collidables::capsule::{Capsule, CapsuleWide, CapsuleSupportFinder};
        use crate::physics::collidables::cylinder::{Cylinder, CylinderWide, CylinderSupportFinder};
        use crate::physics::collidables::box_shape::{Box as BoxShape, BoxWide, BoxSupportFinder};
        use crate::physics::collidables::triangle::{Triangle, TriangleWide, TriangleSupportFinder};
        use crate::physics::collidables::convex_hull::{ConvexHull, ConvexHullWide, ConvexHullSupportFinder};
        use crate::physics::collidables::compound::Compound;
        use crate::physics::collidables::big_compound::BigCompound;
        use crate::physics::collidables::mesh::Mesh;
        ...
        registry.register(Box::new(ConvexPairSweepTask::<Sphere, SphereWide, Sphere, SphereWide, SpherePairDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Sphere, SphereWide, Capsule, CapsuleWide, SphereCapsuleDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Sphere, SphereWide, Cylinder, CylinderWide, SphereCylinderDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Sphere, SphereWide, BoxShape, BoxWide, SphereBoxDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Sphere, SphereWide, Triangle, TriangleWide, SphereTriangleDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Sphere, SphereWide, ConvexHull, ConvexHullWide,
            GJKDistanceTester<Sphere, SphereWide, SphereSupportFinder, ConvexHull, ConvexHullWide, ConvexHullSupportFinder>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Sphere, SphereWide, Compound,
            ConvexCompoundSweepOverlapFinder<Sphere, Compound>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Sphere, SphereWide, BigCompound,
            ConvexCompoundSweepOverlapFinder<Sphere, BigCompound>>::new()));
        registry.register(Box::new(ConvexHomogeneousCompoundSweepTask::<Sphere, SphereWide, Mesh, Triangle, TriangleWide,
            ConvexCompoundSweepOverlapFinder<Sphere, Mesh>>::new()));

        // Capsule vs everything (excluding sphere, already registered above)
        registry.register(Box::new(ConvexPairSweepTask::<Capsule, CapsuleWide, Capsule, CapsuleWide, CapsulePairDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Capsule, CapsuleWide, Cylinder, CylinderWide,
            GJKDistanceTester<Capsule, CapsuleWide, CapsuleSupportFinder, Cylinder, CylinderWide, CylinderSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Capsule, CapsuleWide, BoxShape, BoxWide, CapsuleBoxDistanceTester>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Capsule, CapsuleWide, Triangle, TriangleWide,
            GJKDistanceTester<Capsule, CapsuleWide, CapsuleSupportFinder, Triangle, TriangleWide, TriangleSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Capsule, CapsuleWide, ConvexHull, ConvexHullWide,
            GJKDistanceTester<Capsule, CapsuleWide, CapsuleSupportFinder, ConvexHull, ConvexHullWide, ConvexHullSupportFinder>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Capsule, CapsuleWide, Compound,
            ConvexCompoundSweepOverlapFinder<Capsule, Compound>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Capsule, CapsuleWide, BigCompound,
            ConvexCompoundSweepOverlapFinder<Capsule, BigCompound>>::new()));
        registry.register(Box::new(ConvexHomogeneousCompoundSweepTask::<Capsule, CapsuleWide, Mesh, Triangle, TriangleWide,
            ConvexCompoundSweepOverlapFinder<Capsule, Mesh>>::new()));

        // Cylinder vs everything
        registry.register(Box::new(ConvexPairSweepTask::<Cylinder, CylinderWide, Cylinder, CylinderWide,
            GJKDistanceTester<Cylinder, CylinderWide, CylinderSupportFinder, Cylinder, CylinderWide, CylinderSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Cylinder, CylinderWide, BoxShape, BoxWide,
            GJKDistanceTester<Cylinder, CylinderWide, CylinderSupportFinder, BoxShape, BoxWide, BoxSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Cylinder, CylinderWide, Triangle, TriangleWide,
            GJKDistanceTester<Cylinder, CylinderWide, CylinderSupportFinder, Triangle, TriangleWide, TriangleSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Cylinder, CylinderWide, ConvexHull, ConvexHullWide,
            GJKDistanceTester<Cylinder, CylinderWide, CylinderSupportFinder, ConvexHull, ConvexHullWide, ConvexHullSupportFinder>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Cylinder, CylinderWide, Compound,
            ConvexCompoundSweepOverlapFinder<Cylinder, Compound>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Cylinder, CylinderWide, BigCompound,
            ConvexCompoundSweepOverlapFinder<Cylinder, BigCompound>>::new()));
        registry.register(Box::new(ConvexHomogeneousCompoundSweepTask::<Cylinder, CylinderWide, Mesh, Triangle, TriangleWide,
            ConvexCompoundSweepOverlapFinder<Cylinder, Mesh>>::new()));

        // Box vs everything
        registry.register(Box::new(ConvexPairSweepTask::<BoxShape, BoxWide, BoxShape, BoxWide,
            GJKDistanceTester<BoxShape, BoxWide, BoxSupportFinder, BoxShape, BoxWide, BoxSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<BoxShape, BoxWide, Triangle, TriangleWide,
            GJKDistanceTester<BoxShape, BoxWide, BoxSupportFinder, Triangle, TriangleWide, TriangleSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<BoxShape, BoxWide, ConvexHull, ConvexHullWide,
            GJKDistanceTester<BoxShape, BoxWide, BoxSupportFinder, ConvexHull, ConvexHullWide, ConvexHullSupportFinder>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<BoxShape, BoxWide, Compound,
            ConvexCompoundSweepOverlapFinder<BoxShape, Compound>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<BoxShape, BoxWide, BigCompound,
            ConvexCompoundSweepOverlapFinder<BoxShape, BigCompound>>::new()));
        registry.register(Box::new(ConvexHomogeneousCompoundSweepTask::<BoxShape, BoxWide, Mesh, Triangle, TriangleWide,
            ConvexCompoundSweepOverlapFinder<BoxShape, Mesh>>::new()));

        // Triangle vs everything
        registry.register(Box::new(ConvexPairSweepTask::<Triangle, TriangleWide, Triangle, TriangleWide,
            GJKDistanceTester<Triangle, TriangleWide, TriangleSupportFinder, Triangle, TriangleWide, TriangleSupportFinder>>::new()));
        registry.register(Box::new(ConvexPairSweepTask::<Triangle, TriangleWide, ConvexHull, ConvexHullWide,
            GJKDistanceTester<Triangle, TriangleWide, TriangleSupportFinder, ConvexHull, ConvexHullWide, ConvexHullSupportFinder>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Triangle, TriangleWide, Compound,
            ConvexCompoundSweepOverlapFinder<Triangle, Compound>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<Triangle, TriangleWide, BigCompound,
            ConvexCompoundSweepOverlapFinder<Triangle, BigCompound>>::new()));
        registry.register(Box::new(ConvexHomogeneousCompoundSweepTask::<Triangle, TriangleWide, Mesh, Triangle, TriangleWide,
            ConvexCompoundSweepOverlapFinder<Triangle, Mesh>>::new()));

        // ConvexHull vs everything
        registry.register(Box::new(ConvexPairSweepTask::<ConvexHull, ConvexHullWide, ConvexHull, ConvexHullWide,
            GJKDistanceTester<ConvexHull, ConvexHullWide, ConvexHullSupportFinder, ConvexHull, ConvexHullWide, ConvexHullSupportFinder>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<ConvexHull, ConvexHullWide, Compound,
            ConvexCompoundSweepOverlapFinder<ConvexHull, Compound>>::new()));
        registry.register(Box::new(ConvexCompoundSweepTask::<ConvexHull, ConvexHullWide, BigCompound,
            ConvexCompoundSweepOverlapFinder<ConvexHull, BigCompound>>::new()));
        registry.register(Box::new(ConvexHomogeneousCompoundSweepTask::<ConvexHull, ConvexHullWide, Mesh, Triangle, TriangleWide,
            ConvexCompoundSweepOverlapFinder<ConvexHull, Mesh>>::new()));

        // Compound vs Compound/BigCompound/Mesh
        registry.register(Box::new(CompoundPairSweepTask::<Compound, Compound,
            CompoundPairSweepOverlapFinder<Compound, Compound>>::new()));
        registry.register(Box::new(CompoundPairSweepTask::<Compound, BigCompound,
            CompoundPairSweepOverlapFinder<Compound, BigCompound>>::new()));
        registry.register(Box::new(CompoundHomogeneousCompoundSweepTask::<Compound, Mesh, Triangle, TriangleWide,
            CompoundPairSweepOverlapFinder<Compound, Mesh>>::new()));

        // BigCompound vs BigCompound/Mesh
        registry.register(Box::new(CompoundPairSweepTask::<BigCompound, BigCompound,
            CompoundPairSweepOverlapFinder<BigCompound, BigCompound>>::new()));
        registry.register(Box::new(CompoundHomogeneousCompoundSweepTask::<BigCompound, Mesh, Triangle, TriangleWide,
            CompoundPairSweepOverlapFinder<BigCompound, Mesh>>::new()));
